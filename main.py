...
#         os.makedirs('checkpoints/' + args.exp_name + '/' + 'models')    
#     # 使用 shutil 进行文件复制
#     shutil.copyfile('main.py', 'checkpoints/' + args.exp_name + '/' + 'main.py.backup')
#     shutil.copyfile('model.py', 'checkpoints/' + args.exp_name + '/' + 'model.py.backup')
#     shutil.copyfile('data.py', 'checkpoints/' + args.exp_name + '/' + 'data.py.backup')
